  ...
  process({
    ...
    return new Promise((resolve, reject) => {
      ...
      workQueue.add(() => render(_objectSpread2(_objectSpread2({}, this.options), {}, {
        ...
        outFile: this.sourceMap && path__default['default'].basename(this.id),
  ...
  process({
    ...
    return _asyncToGenerator(function* () {
      ...
      if (style.sourcemap && style.sourcemap.sources) {
        const sourcesContent = yield Promise.all(style.sourcemap.sources.map( /*#__PURE__*/function () {
          var _ref = _asyncToGenerator(function* (file) {
            const absPath = path__default['default'].resolve(file);
            const source = yield pify__default['default'](fs__default['default'].readFile)(absPath, 'utf8');
